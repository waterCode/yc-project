        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse pull-right" id="example-navbar-collapse">
            <ul class="nav navbar-nav thenavbar">
              ...
              <li class="zhuce-li active"><router-link to="/register"><span class="register-image glyphicon glyphicon-cloud"></span><span>注册</span></router-link></li>
              <!---->
